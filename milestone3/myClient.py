...
def thread_creation(target, args=None):
    t = threading.Thread(target=target, args=(args,) if args else ())
    t.daemon = True
    t.start()
...
def player_start():
    ...
    try:
        ...
        print("Enter 1 for playing solo")
        print("Enter 2 to play with a client in the server")
        decision = input("Choose your play mode: ")
        ...
        if decision == '1':
            ...
            try:
                opponent = int(input("Enter the player number you want to play with: "))
                if opponent not in [1, 2] or opponent == currentPlayer:
            ...
            client.send(f"Challenge,{opponent}".encode())
...
def player_start():
    ...
    try:
        ...
        while True:
            print("\nChoose an option:")
            print("1. Play solo")
            print("2. Play with other players")
            ...
            if option == '1':
                ...
                try:
                    opponent = int(input("Enter the player number you want to play with: "))
                    while opponent not in [1, 2] or opponent == currentPlayer:
...
def list_players():
    ...
    while True:
        try:
            ...
            if data_decoded.startswith("Available"):
                msg1 = data_decoded
                allow = 1
                print(msg1)
                break
